...
>> 합친 파일은 첨부파일로 추가하기엔 업로드 사이즈를 초과하여, 깃허브 링크를 첨부합니다. <br>
>>  https://github.com/H-Subin/sm_project/tree/combineProJect(0523)
...
>>
>> - 기능 구현 중 발생한 문제 <br>
>> 지역으로 하든 검색으로 하든 필터링된 가게의 리스트가 전에 필터링된 가게 리스트로 출력되는 문제가 생겼었습니다.
>> 이 문제의 원인은 Log를 통해 알아내였으며, 파이어베이스에 검색하는 시간이 오래걸려서 발생하는 것으로 확인하였습니다. 
>> 즉, 가게의 정보를 ArrayList에 저장하기 전에 다음 코드로 넘어가버리는 것입니다.
>> 이 문제를 해결하기 위해 postDelayed를 사용하여 다음 코드로 넘어가는 딜레이 시간을 1초로 지정해주었습니다.
>> 이로인해 검색, 출력되는 시간이 길어졌지만 확실하게 검색되는 모습을 확인할 수 있었습니다.
>> 다음은 postDelayed를 추가한 코드이며 그 밑 영상은 총 실행영상입니다.

>>![지역구필터링출력](https://user-images.githubusercontent.com/79883808/119355331-1a028100-bce0-11eb-9df6-c31dec304f9c.PNG)
  
>>![검색필터링출력](https://user-images.githubusercontent.com/79883808/119355381-28e93380-bce0-11eb-9f12-0febe335c3df.PNG)
